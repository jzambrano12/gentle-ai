...
| Substantial feature | Initiate SDD automatically: run `sdd-explore` then `sdd-propose`, delegate phases. If the user explicitly asks for SDD ("hazlo con sdd", "use sdd"), start immediately |
